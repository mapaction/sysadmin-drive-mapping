...
Func testSuite()
	...
	Local $testSuite = _testSuite_("SimpleTestSuiteTwo") ;Set test suite name and format (Default format is txt)
	...
	Local $test	= _test_("assertFileExists")
	$test.step("assertFileExists", $test.assertFileExists("C:\test.log"))
	$test.addToSuite($testSuite)
	$test = 0

	Local $test	= _test_("assertFileEquals")
	$test.step("assertFileEquals", $test.assertFileEquals("C:\test.log","C:\test2.log"))
	$test.addToSuite($testSuite)
	$test = 0
